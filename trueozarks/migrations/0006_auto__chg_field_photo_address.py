...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.address'
        db.alter_column('trueozarks_photo', 'address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Photo.address'
        db.alter_column('trueozarks_photo', 'address', self.gf('django.db.models.fields.CharField')(max_length=255))
