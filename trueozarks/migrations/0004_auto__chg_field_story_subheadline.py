...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.subheadline'
        db.alter_column('trueozarks_story', 'subheadline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Story.subheadline'
        db.alter_column('trueozarks_story', 'subheadline', self.gf('django.db.models.fields.CharField')(max_length=255))
