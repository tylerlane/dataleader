...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.in_gallery'
        db.add_column('trueozarks_photo', 'in_gallery', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.in_gallery'
        db.delete_column('trueozarks_photo', 'in_gallery')
