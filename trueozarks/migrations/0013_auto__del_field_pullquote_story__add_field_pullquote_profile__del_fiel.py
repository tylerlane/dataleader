...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PullQuote.story'
        db.delete_column('trueozarks_pullquote', 'story_id')

        # Adding field 'PullQuote.profile'
        db.add_column('trueozarks_pullquote', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['trueozarks.Profile']), keep_default=False)

        # Deleting field 'InfoBox.story'
        db.delete_column('trueozarks_infobox', 'story_id')

        # Adding field 'InfoBox.profile'
        db.add_column('trueozarks_infobox', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['trueozarks.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PullQuote.story'
        db.add_column('trueozarks_pullquote', 'story', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['trueozarks.Story']), keep_default=False)

        # Deleting field 'PullQuote.profile'
        db.delete_column('trueozarks_pullquote', 'profile_id')

        # Adding field 'InfoBox.story'
        db.add_column('trueozarks_infobox', 'story', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['trueozarks.Story']), keep_default=False)

        # Deleting field 'InfoBox.profile'
        db.delete_column('trueozarks_infobox', 'profile_id')
