...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.most_popular'
        db.add_column('trueozarks_profile', 'most_popular', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.most_popular'
        db.delete_column('trueozarks_profile', 'most_popular')
