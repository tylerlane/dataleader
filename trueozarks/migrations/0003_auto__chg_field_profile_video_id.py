...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.video_id'
        db.alter_column('trueozarks_profile', 'video_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.video_id'
        db.alter_column('trueozarks_profile', 'video_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
