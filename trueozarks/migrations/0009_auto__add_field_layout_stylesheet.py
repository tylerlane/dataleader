...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layout.stylesheet'
        db.add_column('trueozarks_layout', 'stylesheet', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Layout.stylesheet'
        db.delete_column('trueozarks_layout', 'stylesheet')
