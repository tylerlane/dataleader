...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Genre.parent'
        db.alter_column('things_genre', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['things.Genre'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Genre.parent'
        db.alter_column('things_genre', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['things.Genre']))
