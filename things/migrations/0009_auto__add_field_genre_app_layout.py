...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Genre.app_layout'
        db.add_column('things_genre', 'app_layout', self.gf('django.db.models.fields.CharField')(default='0', max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Genre.app_layout'
        db.delete_column('things_genre', 'app_layout')
