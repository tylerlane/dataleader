...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('things_event', 'start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2013, 9, 12)), keep_default=False)

        # Adding field 'Event.end_time'
        db.add_column('things_event', 'end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2013, 9, 12)), keep_default=False)
