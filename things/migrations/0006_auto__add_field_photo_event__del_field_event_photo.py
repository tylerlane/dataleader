...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.event'
        db.add_column('things_photo', 'event', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['things.Event']), keep_default=False)

        # Deleting field 'Event.photo'
        db.delete_column('things_event', 'photo_id')


    def backwards(self, orm):
        
        # Deleting field 'Photo.event'
        db.delete_column('things_photo', 'event_id')

        # Adding field 'Event.photo'
        db.add_column('things_event', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['things.Photo']), keep_default=False)
