...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Time.event'
        db.add_column('things_time', 'event', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['things.Event']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Time.event'
        db.delete_column('things_time', 'event_id')
