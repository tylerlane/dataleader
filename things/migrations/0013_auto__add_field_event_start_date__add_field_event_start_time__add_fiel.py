...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('things_event', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2013, 9, 12)), keep_default=False)

        # Adding field 'Event.start_time'
        db.add_column('things_event', 'start_time', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime.now()), keep_default=False)

        # Adding field 'Event.end_date'
        db.add_column('things_event', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2013, 9, 12)), keep_default=False)

        # Adding field 'Event.end_time'
        db.add_column('things_event', 'end_time', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime.now()), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.start_date'
        db.delete_column('things_event', 'start_date')

        # Deleting field 'Event.start_time'
        db.delete_column('things_event', 'start_time')

        # Deleting field 'Event.end_date'
        db.delete_column('things_event', 'end_date')
