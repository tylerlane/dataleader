...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AYPDetail.school_total'
        db.delete_column('schools_aypdetail', 'school_total')

        # Adding field 'AYPDetail.comm_school_total'
        db.add_column('schools_aypdetail', 'comm_school_total', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True), keep_default=False)

        # Adding field 'AYPDetail.math_school_total'
        db.add_column('schools_aypdetail', 'math_school_total', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AYPDetail.school_total'
        db.add_column('schools_aypdetail', 'school_total', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=5), keep_default=False)

        # Deleting field 'AYPDetail.comm_school_total'
        db.delete_column('schools_aypdetail', 'comm_school_total')

        # Deleting field 'AYPDetail.math_school_total'
        db.delete_column('schools_aypdetail', 'math_school_total')
    ...
    models = {
        'schools.aypdetail': {
            ...
            'comm_school_total': ('django.db.models.fields.IntegerField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            ...
            'math_school_total': ('django.db.models.fields.IntegerField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
