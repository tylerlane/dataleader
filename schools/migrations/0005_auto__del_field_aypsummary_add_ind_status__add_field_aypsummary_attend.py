...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AYPSummary.add_ind_status'
        db.delete_column('schools_aypsummary', 'add_ind_status')

        # Adding field 'AYPSummary.attendance_status'
        db.add_column('schools_aypsummary', 'attendance_status', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'AYPSummary.graduation_status'
        db.add_column('schools_aypsummary', 'graduation_status', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AYPSummary.add_ind_status'
        db.add_column('schools_aypsummary', 'add_ind_status', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Deleting field 'AYPSummary.attendance_status'
        db.delete_column('schools_aypsummary', 'attendance_status')

        # Deleting field 'AYPSummary.graduation_status'
        db.delete_column('schools_aypsummary', 'graduation_status')
