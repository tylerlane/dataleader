...
urlpatterns = patterns("schools.views",
    ...
    url(r"schools/ayp/detail/(?P<district>.*)/(?P<school>.*)$",
            "get_school_ayp_xml", name="get_school_ayp_xml"),
    url(r"schools/ayp/detail/(?P<district>.*)$", "get_school_ayp_xml",
        name="get_school_ayp_xml2"),
)
