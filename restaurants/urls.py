...
urlpatterns = patterns('restaurants.views',
    ...
    url(r'^restaurants/neighborhood_kml/(?P<neighborhood>.*)','neighborhood_kml', name='neighborhood_kml'),
    ...
    #contest stuff
    url(r'^restaurants/contest/error','contest_error',name='contest_error'),
    url(r'^restaurants/contest/success','contest_success',name='contest_success'),
    url(r'^restaurants/contest','contest_entry',name='contest_entry'),
    url(r'^restaurants/nearme','nearme',name='nearme'),
    #admin pages
