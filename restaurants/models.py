...
class Restaurant( models.Model ):
  ...
  last_updated = models.DateTimeField( "Last Updated",auto_now=False,auto_now_add=False,null=True)
...
class Inspection( models.Model ):
  ...
  date = models.DateTimeField("Inspection Date", auto_now=False, auto_now_add=False)
