...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Restaurant.rating_sum'
        db.add_column('restaurants_restaurant', 'rating_sum', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Restaurant.rating_total_votes'
        db.add_column('restaurants_restaurant', 'rating_total_votes', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.rating_sum'
        db.delete_column('restaurants_restaurant', 'rating_sum')

        # Deleting field 'Restaurant.rating_total_votes'
        db.delete_column('restaurants_restaurant', 'rating_total_votes')
