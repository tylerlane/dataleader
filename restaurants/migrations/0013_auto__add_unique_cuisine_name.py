...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Cuisine', fields ['name']
        db.create_unique('restaurants_cuisine', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Cuisine', fields ['name']
        db.delete_unique('restaurants_cuisine', ['name'])
