...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cuisine.label'
        db.alter_column('restaurants_cuisine', 'label', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Cuisine.label'
        db.alter_column('restaurants_cuisine', 'label', self.gf('django.db.models.fields.CharField')(max_length=150))
