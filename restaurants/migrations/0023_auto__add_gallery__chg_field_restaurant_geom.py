...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('restaurants', ['Gallery'])

        # Changing field 'Restaurant.geom'
        db.alter_column('restaurants_restaurant', 'geom', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting model 'Gallery'
        db.delete_table('restaurants_gallery')
