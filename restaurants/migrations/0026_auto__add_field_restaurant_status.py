...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('restaurants_restaurant', 'status', self.gf('django.db.models.fields.CharField')(default='NEW', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.status'
        db.delete_column('restaurants_restaurant', 'status')
