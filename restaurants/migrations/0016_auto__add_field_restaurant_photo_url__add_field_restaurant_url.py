...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Restaurant.photo_url'
        db.add_column('restaurants_restaurant', 'photo_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Restaurant.url'
        db.add_column('restaurants_restaurant', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.photo_url'
        db.delete_column('restaurants_restaurant', 'photo_url')

        # Deleting field 'Restaurant.url'
        db.delete_column('restaurants_restaurant', 'url')
