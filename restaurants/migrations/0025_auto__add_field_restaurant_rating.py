...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('restaurants_restaurant', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.rating'
        db.delete_column('restaurants_restaurant', 'rating')
