/*!
 * tn3 mediaelemnt plugin v1.4.0.101
 * http://tn3gallery.com/
 *
 * License
...
this));a.execute=false;setTimeout(b.proxy(this.tn3.fullscreen,this.tn3),50)}}else if(a.id=="play"){if(this.slideshowPlay)a.execute=false;(this.tn3WasPlaying=c.media.paused)?c.play():c.pause()}},onMEFullScreen:function(){if(!mejs.MediaFeatures.isFullScreen()){this.resize();this.mep.container.css("position","static")}}}})(jQuery);
