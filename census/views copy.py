...
def index( request,embed=None ):
	...
	if embed is None:
		return render_to_response( "census/index.html",{'states': states }, context_instance = RequestContext( request ) )
	else:
		return render_to_response( "census/embed/index.html", {"states": states }, context_instance = RequestContext( request ) )
...
def list_counties( request, state,embed=None ):
	...
	if embed is None:
		return render_to_response( "census/counties.html", {"counties": counties, 'state': state,"state_data":state_data }, context_instance =  RequestContext( request ) )
	else:
		return render_to_response( "census/embed/counties.html", {"counties": counties, "state": state, "state_data":state_data }, context_instance = RequestContext( request ) )
...
def list_cities( request, state,embed=None  ):
	...
	if embed is None:
		return render_to_response( "census/cities.html", {"cities": cities, "state": state, "state_data":state_data }, context_instance = RequestContext( request ) )
	else:
		return render_to_response( "census/embed/cities.html", {"cities": cities, "state": state, "state_data":state_data }, context_instance = RequestContext( request ) )
...
def county_detail( request, state, county, embed=None ):
	...
	if embed is None:
		return render_to_response( "census/county_detail.html", {"county": county, "state": state }, context_instance = RequestContext( request ) )
	else:
		return render_to_response( "census/embed/county_detail.html", {"county": county, "state": state }, context_instance = RequestContext( request ) )
...
def city_detail( request, state, city, embed=None ):
	...
	if embed is None: 
		return render_to_response( "census/city_detail.html", {"city": city, "state": state }, context_instance = RequestContext( request ) )
	else:
		return render_to_response( "census/embed/city_detail.html", {"city": city, "state": state }, context_instance = RequestContext( request ) )
...
def state_detail( request, state, embed = None ):
	...
	if embed is None:
		return render_to_response( "census/state_detail.html", { "state": state }, context_instance = RequestContext( request ) )
	else:
		return render_to_response( "census/embed/state_detail.html", { "state": state }, context_instance = RequestContext( request ) )
