...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CountyData.land_sqmiles'
        db.add_column('census_countydata', 'land_sqmiles', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'CountyData.dividx2010'
        db.alter_column('census_countydata', 'dividx2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pct2ormore2010'
        db.alter_column('census_countydata', 'pct2ormore2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pcthisp2010'
        db.alter_column('census_countydata', 'pcthisp2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctamind2000'
        db.alter_column('census_countydata', 'pctamind2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctasian2000'
        db.alter_column('census_countydata', 'pctasian2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctwhitenonhisp2000'
        db.alter_column('census_countydata', 'pctwhitenonhisp2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctother2010'
        db.alter_column('census_countydata', 'pctother2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctblack2010'
        db.alter_column('census_countydata', 'pctblack2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctnonhisp2010'
        db.alter_column('census_countydata', 'pctnonhisp2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctwhite2010'
        db.alter_column('census_countydata', 'pctwhite2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.dividx2000'
        db.alter_column('census_countydata', 'dividx2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pct2ormore2000'
        db.alter_column('census_countydata', 'pct2ormore2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pcthisp2000'
        db.alter_column('census_countydata', 'pcthisp2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctamind2010'
        db.alter_column('census_countydata', 'pctamind2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctnathaw2010'
        db.alter_column('census_countydata', 'pctnathaw2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctasian2010'
        db.alter_column('census_countydata', 'pctasian2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctwhitenonhisp2010'
        db.alter_column('census_countydata', 'pctwhitenonhisp2010', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctother2000'
        db.alter_column('census_countydata', 'pctother2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctblack2000'
        db.alter_column('census_countydata', 'pctblack2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctnonhisp2000'
        db.alter_column('census_countydata', 'pctnonhisp2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctwhite2000'
        db.alter_column('census_countydata', 'pctwhite2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pctnathaw2000'
        db.alter_column('census_countydata', 'pctnathaw2000', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'CountyData.land_sqmiles'
        db.delete_column('census_countydata', 'land_sqmiles')
    ...
    models = {
        'census.countydata': {
            ...
            'land_sqmiles': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
