...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('census_countydata', 'pop2000SqMile', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'CountyData.pop2010SqMile'
        db.alter_column('census_countydata', 'pop2010SqMile', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))
